...
BEGIN
	BEGIN TRY
		...
		BEGIN TRANSACTION;
			...
			[Wholesale Carton Area],
			[Wholesale Carton Barcode],
			[Wholesale Unit Quantity Per Carton],
			[Wholesale Unit Quantity Per Pallet Level],
			[Wholesale Total Unit Quantity Per Pallet],
			...
			[Wholesale Pallet Area],
			[Wholesale Pallet Barcode],
			[Wholesale Carton Quantity Per Pallet Level],
			[Wholesale Total Carton Quantity Per Pallet],
