...
(SUM(CASE WHEN OT.[OrderType] = 'Final' AND OPS.[OrderPaymentStatus] != 'Settled' AND PM.[PaymentMethod] = 'Account Credit' THEN VOV.[TotalOrderValue] ELSE 0 END) / C.[CreditLimit]) * 100 AS [Credit Limit Used Percentage]
FROM [dbo].[Customer] C
