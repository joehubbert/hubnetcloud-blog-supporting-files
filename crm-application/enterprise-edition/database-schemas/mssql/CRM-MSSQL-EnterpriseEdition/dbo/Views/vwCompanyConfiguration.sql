...
CC.[BankAccountSortCode] AS [Bank Account Sort Code],
CC.[BankAccountIBAN] AS [Bank Account IBAN],
CC.[BankAccountSWIFTCode] AS [Bank Account SWIFT Code],
CC.[BankAccountAddressLine1] AS [Bank Account Address Line 1],
CC.[BankAccountAddressLine2] AS [Bank Account Address Line 2],
CC.[BankAccountAddressLine3] AS [Bank Account Address Line 3],
CC.[BankAccountAddressLine4] AS [Bank Account Address Line 4],
CC.[BankAccountAddressLine5] AS [Bank Account Address Line 5],
CC.[BankAccountVippsId] AS [Bank Account Vipps Id],
