...
namespace CRM.Presentation.CompanyManagement.CurrencyConversion
{
    public partial class CurrencyConversionDetail : Form
    {
        ...
        private async void CurrencyConversionDetailCurrencyConversionInformation_Load(object sender, EventArgs e)
        {
            ...
            try
            {
                DataTable? currencyConversionDataTable = await DBInterface.ExecuteSelectStoredProcedureAsync(dataSubject, _databaseConnectionSettings, storedProcedureName, parameters);
        ...
        private async void currencyConversionDetailUpdateCurrencyConversionButton_Click(object sender, EventArgs e)
        {
            ...
            if (currencyConversionDetailAddExpiryDateRadioButtonChoiceYesRadioButton.Checked)
            {
                ...
                DateComparisonHelper.ValidateEffectiveAndExpiryDates(currencyConversionDetailEffectiveDatePicker, currencyConversionDetailExpiryDatePicker);
            ...
            string targetBText = TextBoxCleanerHelper.GetTrimmedText(currencyConversionDetailTargetCurrencyValueTextBoxB);
