...
namespace CRM.Presentation.CompanyManagement.AccountManagement
{
    public partial class AccountManagerDetail : Form
    {
        ...
        private async void AccountManagerDetailAccountManagerInformation_Load(object sender, EventArgs e)
        {
            ...
            try
            {
                DataTable? accountManagerDataTable = await DBInterface.ExecuteSelectStoredProcedureAsync(dataSubject, _databaseConnectionSettings, storedProcedureName, parameters);
